...
func InitOptionMap() {
	...
	// 明细日志保留天数（design-v1 §16.5，默认 30）；实际清理由 POST /logs/prune 触发。
	common.OptionMap["PBRLogRetentionDays"] = strconv.Itoa(30)
	// 探活并发上限（design-v1 §16.6，默认 4）。
	common.OptionMap["PBRProbeConcurrency"] = strconv.Itoa(4)
